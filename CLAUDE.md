...
**Production:** Danielsson Insights add-on v0.2.4 on HAOS — all bridges + timeline + Influx.
...
| `influx_metrics_bridge.py` | Tails `metrics.jsonl` → InfluxDB (in add-on when `influx_url` set) |
